...
DeviceWatcher::WorkerThread::WorkerThread(QObject *parent)
    : QThread(parent)
{
}

void DeviceWatcher::WorkerThread::init(const QString &action, const DeviceWatcher::UDevProperties &properties)
{
    m_action = action;
    m_properties = properties;
}

void DeviceWatcher::WorkerThread::run()
{
